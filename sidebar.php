...
<ul>
	<li><img src="<?php bloginfo('template_directory'); ?>/images/freecall.png" border="0" alt="Freecall" /></li>
	<li class="sidebar_category">
		<div class="category_border"><h2><?php _e('Kategorien'); ?></h2></div>
			<ul>
			<?php wp_list_cats(); ?> 
			</ul>
	</li>
	...
	<?php if ( is_home() ) { wp_list_bookmarks(array('class' => 'noncat')); } ?>	
