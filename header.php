...
<head>
	...
	<script src="<?php bloginfo('template_directory');?>/js/jquery.placeholder.1.3.min.js"></script>
				...
				<div class="logo">
					<h1>
						<a href="<?php echo get_settings('home'); ?>">
							<img src="<?php print(get_stylesheet_directory_uri() . '/images/header_logo.png'); ?>" alt="Logo der Magento und TYPO3 Agentur in Karlsruhe" />
						</a>
					</h1>
				</div>
			</div>
